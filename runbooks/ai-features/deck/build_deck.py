...
EN = dict(
  ...
  s15_facts=[("mic","Any meeting platform","It records the room microphone and the meeting audio in the browser tab, so <span class='ltr'>Teams</span>, <span class='ltr'>Webex</span>, <span class='ltr'>Zoom</span> or <span class='ltr'>Meet</span> all work — with no integration and no bot joining the call."),
             ("notes","Bilingual minutes, in one pass","Arabic and English minutes are drafted together, with action items, owners and due dates. It will not invent an attendee, a decision or a deadline, and nothing is filed until someone approves it."),
             ...
             ("lock","The recording is never kept","Audio is transcribed and discarded — the platform stores no recording. For sensitive sessions, transcription can run fully on-device instead of through a cloud model.")],
  s13_h="Thank you.",
...
AR = dict(
  ...
  s15_facts=[("mic","يعمل مع أي منصة اجتماعات","يلتقط صوت القاعة وصوت الاجتماع من المتصفح، فتعمل <span class='ltr'>Teams</span> و<span class='ltr'>Webex</span> و<span class='ltr'>Zoom</span> و<span class='ltr'>Meet</span> جميعها دون ربط تقني ودون مشارك آلي في الاجتماع."),
             ("notes","محضر عربي وإنجليزي في مسار واحد","يُصاغ المحضر بالعربية والإنجليزية معاً، مع المهام ومسؤوليها وتواريخ استحقاقها. ولا يضيف حاضراً أو قراراً أو موعداً من عنده، ولا يُحفظ شيء قبل الاعتماد."),
             ...
             ("lock","التسجيل الصوتي لا يُحفظ","يُفرَّغ الصوت نصياً ثم يُتلف، فلا تحتفظ المنصة بأي تسجيل. وللجلسات الحساسة يمكن تشغيل التفريغ داخل أجهزتكم بالكامل بدل النموذج السحابي.")],
  s13_h="شكراً لكم.",
